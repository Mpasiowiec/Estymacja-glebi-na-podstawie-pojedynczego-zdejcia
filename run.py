...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--input_rgb_dir",
        type=str,
        default="/content/drive/MyDrive/magisterka/Estymacja-glebi-na-podstawie-pojedynczego-zdejcia",
    ...
    pipe: MarigoldPipeline = get_Marigold(trained=True, variant=variant, torch_dtype=dtype)
