...
from models.help_funciton_Marigold import *
...
def get_Marigold(trained=False, **kwargs):

    pipe = MarigoldPipeline.from_pretrained("prs-eth/marigold-depth-lcm-v1-0", **kwargs)
